#!/usr/bin/env bash
# Bulk-export 3-sjøersløpet O₁ gravel-road anchor HITL dashboards (1 km chunks).
...
MANIFEST="config/spatial_align_manifest_3_sjoerslopet.json"
TERRAIN_MAP="config/spatial_terrain_map_3_sjoerslopet.json"
PANEL="03_Processed_Data/spatial/3_sjoerslopet_course/panel_1m.parquet"
OUT_DIR="06_Visualizations/3_sjoerslopet_hitl"
DONOR="Subject_A"
RACE_ID="3_sjoerslopet"
...
act = (m.get("activities") or [{}])[0].get("activity_id", "3_Sjoerslopet")
...
LOCOMOTION_SIDECAR="03_Processed_Data/spatial/3_sjoerslopet_course/locomotion_mode_1m.parquet"
...
ML_PRED="03_Processed_Data/spatial/3_sjoerslopet_course/3_sjoerslopet_ml_predictions.parquet"
ML_ARGS=()
...
manifest = {
    ...
    "race_id": "$RACE_ID",
    "geography": "Sandnes · Rogaland",
    "axis_label": "3_sjoerslopet stream km",
...
echo "OK 3-sjøersløpet HITL export complete → $OUT_DIR (${N_CHUNKS} chunks, km ${KM_START}–${KM_END})"
