...
**2026-10 peak simulator (private blueprint / local override):** Store Stokkavatnet + Hålandsvatnet — total 16–18 km; base **6:45** easy companion cruise (local override via `apply_october_local_overrides.py`); fast finish **3–5 km @ 4:44**; mandatory early carbs 45–60 g/hr. Evaluator scores finish only — base pace ignored. → local `execution_protocols.2026-10-peak`.
